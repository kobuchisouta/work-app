        ...
        <div className={styles.page}>
            ...
            <main className={styles.container}>
                ...
                <section style={{ marginTop: 18 }}>
                    <h2 style={{ fontSize: 18, fontWeight: 800, marginBottom: 10 }}>学習履歴（動画）</h2>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                            ...
                            >
                                <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}>
                                    <h3 style={{ fontSize: 16, fontWeight: 800 }}>✅ 視聴完了</h3>
                                    ...
                                    <ul style={{ marginTop: 10, paddingLeft: 18 }}>
                                        {completedVideos.map((v) => (
                                            <li key={v.videoId} style={{ marginBottom: 8 }}>
                                                <div style={{ fontWeight: 700 }}>{v.title || v.videoId}</div>
                                                <div style={{ fontSize: 12, opacity: 0.75, marginTop: 2 }}>
                                                    {v.skillTags?.join(" / ") || "タグなし"}
                                                    {" · "}
                                                    {(v.progress ? Math.round(v.progress * 100) : 0)}%
                            ...
                            >
                                <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}>
                                    <h3 style={{ fontSize: 16, fontWeight: 800 }}>⏳ 視聴途中</h3>
